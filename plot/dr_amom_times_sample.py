...
fig_width_inches = 4. # TOTAL figure width, in inches
...
for i in range(index_first, index_last + 1):
    ...
    savename = 'dr_amom_iter' + str(iter1).zfill(8) + '.png'
    ...
    plot_azav (diffrot, rr, cost, fig=fig, ax=ax1, units='nHz',\
            ...
            plotlatlines=plotlatlines)
    fsize = 12.
    line_height = 1./4./fig_height_inches
    fig.text(1.5*margin_x + subplot_width, 1 - margin_y, dirname_stripped,\
             ha='center', va='top', fontsize=fsize, **csfont)
    fig.text(margin_x, 1 - margin_y - line_height, r'$\Omega - \Omega_0$',\
    ...
    plot_azav (amom, rr, cost, fig=fig, ax=ax2,\
            ...
            rvals=rvals, plotlatlines=plotlatlines)
    # Make a title
    ...
    fig.text(1.5*margin_x + subplot_width, 1 - margin_y - 3.5*line_height,\
