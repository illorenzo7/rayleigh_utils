...
# Saves plot in
# [dirname]_forces_radial_[first iter]_[last iter].png
...
# Get AZ_Avgs file
print ('Getting radial forces from ' + datadir + AZ_Avgs_file + ' ...')
...
for iplot in range(nplots):
    ...
    plot_azav (r_forces[iplot], rr, cost, sint, fig=fig, ax=ax, units=units,\
    minmax=(my_min, my_max), norm=MidpointNormalize(0.),\
...
if saveplot:
    print ('Saving radial forces at ' + savefile + ' ...')
