...
# Reading in various Rayleigh slices
...
# Mollweide and Orthographic transforms
def mollweide_transform(costheta, clon=0., shrinkage=1., precision=1e-3): 
...
# Pspec (l,m) - colorplot
plot_spec_lm_kwargs_default =\
    dict({'lvals': None, 'mvals': None, 'linewidth': default_lw,\
    'minmax': None, 'lminmax', 'mminmax', # colorbar stuff
