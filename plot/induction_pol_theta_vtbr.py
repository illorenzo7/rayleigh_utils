...
# Get induction terms
ind_off = 16
indices_mm = ind_off + np.arange(0, 16, 4)
indices_pp = ind_off + np.arange(0, 16, 4) + 2
terms = []
...
units = r'$\rm{G\ s^{-1}}$'
titles = [r'$\frac{1}{r}\frac{\partial}{\partial r}[r\langle v_\theta\rangle\langle B_r\rangle]$',\
r'$\left\langle\frac{\partial v_\theta}{\partial r}\right\rangle\left\langle B_r\right\rangle$',\
r'$\left\langle v_\theta\right\rangle\left\langle \frac{\partial B_r}{\partial r}\right\rangle$',\
r'$\frac{1}{r}\left\langle v_\theta\right\rangle\left\langle B_r\right\rangle$',\
'sum of 3',\

    r'$\frac{1}{r}\frac{\partial}{\partial r}[r\langle v_\theta^\prime B_r^\prime\rangle]$',\
    r'$\left\langle \frac{\partial v_\theta^\prime}{\partial r} B_r^\prime\right\rangle$',\
    r'$\left\langle v_\theta^\prime \frac{\partial B_r^\prime}{\partial r}\right\rangle$',\
r'$\frac{1}{r}\left\langle v_\theta^\prime B_r^\prime\right\rangle$',\
'sum of 3']
...
fig.text(margin_x, 1 - 0.3*margin_top, 'theta-induction (vt-br cor)',\
         ha='left', va='top', fontsize=fsize, **csfont)
fig.text(margin_x, 1 - 0.5*margin_top, time_string,\
         ha='left', va='top', fontsize=fsize, **csfont)

savefile = plotdir + dirname_stripped + '_induction_pol_theta_vtbr_' +\
