...
# Saves plot in
# [dirname]_induction_phi_fluc_[first iter]_[last iter].png
...
# Get induction terms
indices = [1611, 1612, 1613, 1614]
indices_mean = [1626, 1627, 1628, 1629]
...
fig.text(margin_x, 1 - 0.3*margin_top, 'Phi-induction (fluc)',\
         ha='left', va='top', fontsize=fsize, **csfont)
fig.text(margin_x, 1 - 0.5*margin_top, time_string,\
         ha='left', va='top', fontsize=fsize, **csfont)

savefile = plotdir + dirname_stripped + '_induction_phi_fluc_' +\
