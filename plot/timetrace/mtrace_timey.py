...
# defaults
kwargs_default = dict({'rad': False, 'groupname': 'v', 'sampletag': '', 'the_file': None, 'isamplevals': np.array([0]), 'samplevals': None, 'rvals': None, 'qvals': 'all', 'ntot': 500, 'mval': 1, 'imag': False, 'abs': False, 'prepend': False, 'ntheta': None, 'xminmax': None, 'xmin': None, 'xmax': None})
