...
# defaults
kw_default = dict({'the_file': None, 'ntot': 500, 'tavg': None, 'clat': 10, 'dlat': 0, 'omega': None, 'rad': False, 'isamplevals': np.array([0]), 'samplevals': None, 'rvals': None, 'groupname': 'v', 'sub': False, 'prepend': False, 'ntheta': None, 'tkappa': False})
