...
terms.append(vals_bd[:, :, 0]) # mean correlation #1
terms.append(vals_bd[:, :, 1]) # mean correlation #2
terms.append(vals_bd[:, :, 2]) # fluc correlation #1
terms.append(vals_bd[:, :, 3]) # fluc correlation #2
