...
if the_tuple is None: # By default plot the last all Shell_Slices
...
for iiter in range(index_first, index_last + 1):
    ...
    plot_moll(field, a.costheta, fig=fig, ax=ax, clon=clon, minmax=minmax,\
            varname=varname, posdef=posdef, logscale=logscale,\
            lw_scaling=0.7)     
