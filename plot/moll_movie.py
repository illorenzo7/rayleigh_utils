...
# Get a default minmax value for the field if none was specified by user
...
print ("Plotting slices " + fnames[0] + " through " + fnames[-1])
...
#        print(savename)
        ...
        ax = fig.add_axes([margin_x, margin_bottom,\
