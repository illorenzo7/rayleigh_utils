# Created 04/23/2020
# Plots and saves meridional slice associated with a given variable
# at a given time over the range of available longitudes
# Similar to moll_rvals_sample
...
# Loop over lonvals and make plots
for iphi in range(mer.nphi):
    # Get field associated with particular lon value
    field = vals[iphi, :, :]
