...
# Saves plot in
# [dirname]_induction_theta_fluc_[first iter]_[last iter].png
...
# Get induction terms
indices = [1606, 1607, 1608, 1609]
indices_mean = [1621, 1622, 1623, 1624]
...
fig.text(margin_x, 1 - 0.3*margin_top, 'theta-induction (fluc)',\
         ha='left', va='top', fontsize=fsize, **csfont)
fig.text(margin_x, 1 - 0.5*margin_top, time_string,\
         ha='left', va='top', fontsize=fsize, **csfont)

savefile = plotdir + dirname_stripped + '_induction_theta_fluc_' +\
