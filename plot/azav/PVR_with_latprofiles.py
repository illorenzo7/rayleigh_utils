...
kw_default = dict({'the_file': None, 'verbose': False, 'absom': False, 'hrho': False})
...
Q = omr_av + 2*eq.omega0*cost_2d
if kw.hrho:
    hrho = -1./eq.dlnrho
main_savename = 'PVR_lat'
if kw.hrho:
    xlabel = r'$(\langle \omega_r\rangle +2\Omega_0\sin(\theta)/H_\rho$' 
else:
    xlabel = r'$(\langle \omega_r\rangle +2\Omega_0\sin(\theta)$' 
