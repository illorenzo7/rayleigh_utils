...
savename = dirname_stripped + '_p_spherical_mean_' + file_list[index_first] + '_' +\
...
for ii in range (index_first, index_last):
    ...
    shellavg = ShellAverage(radatadir + file_list[ii], '')
...
print ('Saving spherical pressure mean at ' + savefile + ' ...')
