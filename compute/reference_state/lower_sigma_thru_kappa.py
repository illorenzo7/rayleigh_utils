...
# to contain heating a kappa that greatly increases within the RZ
# to ensure that sigma stays low, even with a stiff RZ
...
#    (default "customfile")
# --delta : transition width in kappa: try ~2/3 of transition in dS/dr
#    (default 0.02)
# --nr
...
# --sigma: this the value of the "real" sigma profile we're shooting for
# --rbcz : bottom of CZ
# --rtcz : top of CZ
...
kw_default = dotdict(dict({'fname': 'customfile', 'jup': False, 'sun': False, 'rbcz': None, 'rtcz': None, 'delta': 0.02, 'nr': 10000, 'sigma': 0.2}))
