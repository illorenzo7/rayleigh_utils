...
savename = dirname_stripped + '_vr_vp_dist_df_1_lowlat_tbl_' +\
...
dist_tbl = dist[ir_tbl]
dist_tbl[-1, :] = dist_tbl[-2, :] # "Fix the fuck-up I made on the last bin
savename = dirname_stripped + '_vr_vp_dist_df_2_lowmidlat_tbl_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
savefile = datadir + savename
print ('Saving ' + savefile + ' ...')
np.save(savefile, dist_tbl)
...
dist_tbl = dist[ir_tbl]
dist_tbl[-1, :] = dist_tbl[-2, :] # "Fix the fuck-up I made on the last bin
savename = dirname_stripped + '_vr_vp_dist_df_3_midlat_tbl_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
savefile = datadir + savename
print ('Saving ' + savefile + ' ...')
np.save(savefile, dist_tbl)
...
dist_tbl = dist[ir_tbl]
dist_tbl[-1, :] = dist_tbl[-2, :] # "Fix the fuck-up I made on the last bin
savename = dirname_stripped + '_vr_vp_dist_df_4_midhighlat_tbl_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
savefile = datadir + savename
print ('Saving ' + savefile + ' ...')
np.save(savefile, dist_tbl)
...
dist_tbl = dist[ir_tbl]
dist_tbl[-1, :] = dist_tbl[-2, :] # "Fix the fuck-up I made on the last bin
savename = dirname_stripped + '_vr_vp_dist_df_5_highlat_tbl_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
savefile = datadir + savename
print ('Saving ' + savefile + ' ...')
np.save(savefile, dist_tbl)
...
dist_tbl = dist[ir_tbl]
dist_tbl[-1, :] = dist_tbl[-2, :] # "Fix the fuck-up I made on the last bin
savename = dirname_stripped + '_vr_vp_dist_df_6_superhighlat_tbl_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
savefile = datadir + savename
print ('Saving ' + savefile + ' ...')
np.save(savefile, dist_tbl)