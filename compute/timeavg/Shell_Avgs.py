...
f = open(savefile, 'wb')
pickle.dump({'vals': vals, 'lut': sh0.lut, 'count': count, 'iter1': iter1, 'iter2': iter2, 'qv': sh0.qv, 'nq': sh0.nq, 'rr': rr, 'rr_depth': rr_depth, 'rr_height': rr_height, 'nr': nr, 'ri': ri, 'ro': ro, 'd': d}, f, protocol=4)
f.close()
