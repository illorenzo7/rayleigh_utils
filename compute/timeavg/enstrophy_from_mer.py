...
np.save(savefile, {'vals': vals, 'lut': mer0.lut, 'count': count, 'iter1': iter1, 'iter2': iter2,\
       'phivals': phivals, 'phivals_lon': phivals_lon, 'nphi': nphi, 'rr': rr, 'rr_depth': rr_depth, 'rr_height': rr_height, 'nr': nr, 'ri': ri, 'ro': ro, 'd': d, 'tt': tt, 'tt_lat': tt_lat, 'sint': sint, 'cost': cost,'nt': nt, 'rr_2d': rr_2d, 'tt_2d': tt_2d, 'sint_2d': sint_2d, 'cost_2d': cost_2d, 'xx': xx, 'zz': zz})
