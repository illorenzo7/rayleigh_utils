...
# Broadcast meta data
if rank == 0:
    meta = [dirname, radatadir, irvals,  mmax]
else:
    meta = None
dirname, radatadir, irvals,  mmax = comm.bcast(meta, root=0)
...
for irval in irvals:
    ...
    my_vals = np.fft.rfft(my_vals, axis=2)
    ...
    if rank == 0:
        ...
        vals = np.zeros((ntimes, 9, nm, nt), 'complex')
