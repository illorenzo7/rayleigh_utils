...
# to contain heating profile that is confined to CZ, SHARPLY
# i.e., heating drops discontinuously to zero in the RZ
...
heat = rho*tmp # used to subtract off "top" value in dimensional
...
print(buff_line)
print("Computed heating for RZ-CZ, profile ~ rho*T, STRICTLY in CZ")
if kw.jup:
...
f.write("generate_CZ_RZ_heating_sharp-nd routine.\n")
