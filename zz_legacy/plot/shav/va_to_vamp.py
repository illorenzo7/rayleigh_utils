...
amp_min = np.min((v_A/vamp)[ir1:ir2])
amp_max = np.max((v_A/vamp)[ir1:ir2])
if minmax is None:
    fact = 0.2
    if logscale:
...
savefile = plotdir + dirname_stripped + '_va_to_vamp_' +\
