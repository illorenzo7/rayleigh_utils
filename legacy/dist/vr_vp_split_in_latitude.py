...
# (computed from dist/vr_s.py) and creates six subdistributions:
# 1_lowlat (+/- 15 degrees)
...
savename = dirname_stripped + '_vr_vp_dist_full_1_lowlat_' +\
...
savename = dirname_stripped + '_vr_vp_dist_full_2_lowmidlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_vp_dist_full_3_midlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_vp_dist_full_4_midhighlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')    
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_vp_dist_full_5_highlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')    
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_vp_dist_full_6_superhighlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')   
np.save(datadir + savename, subdist)