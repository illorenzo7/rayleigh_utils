...
# Created: 02/25/2018
# This script computes the 2-D distribution for v_r and v_phi (for the downflows
# only) at each point in the nt x nr meridional plane. 
# Requires the data produced by dist/bininfo/vr_vp_df.py stored in 
# vrvp_df_binedges.npy, vrvp_df_binspacing.npy
# Outputs the distribution as (nt, nr, nbins_vr, nbins_vp) (big file!) at 
# [dirname]_vr_vp_dist_df_[first iter]_[last iter].npy
...
savename = dirname_stripped + '_vr_vp_dist_full_' + file_list[index_first] + '_' +\
