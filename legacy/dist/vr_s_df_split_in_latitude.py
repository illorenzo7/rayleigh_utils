...
# Created: 05/07/2018
# This script takes the joint v_r and S' distribution at all latitudes 
# (for the downflows only)
# (computed from dist/vr_s_df.py) and creates six subdistributions:
# 1_lowlat (+/- 15 degrees)
...
savename = dirname_stripped + '_vr_s_dist_df_1_lowlat_' +\
...
savename = dirname_stripped + '_vr_s_dist_df_2_lowmidlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_s_dist_df_3_midlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_s_dist_df_4_midhighlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')    
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_s_dist_df_5_highlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')    
np.save(datadir + savename, subdist)
...
subdist = np.sum(dist[it1:it2, :, :, :], axis=0) +\
    np.sum(dist[it3:it4, :, :, :], axis=0)
savename = dirname_stripped + '_vr_s_dist_df_6_superhighlat_' +\
    str(iter1).zfill(8) + '_' + str(iter2).zfill(8) + '.npy'
print ('Saving ' + datadir + savename + ' ...')   
np.save(datadir + savename, subdist)